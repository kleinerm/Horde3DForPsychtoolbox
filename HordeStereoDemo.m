function HordeStereoDemo(smode, windowed)
% Demonstration of usage of Horde3D engine from within Psychtoolbox with stereo display.
%
% Usage:
%
% HordeStereoDemo([stereomode=8][windowed=0]);
% - The optional 'stereomode' parameter selects the type of stereo display
% algorithm used. Defaults to 8 aka Anaglyph Red-Blue stereo.
%
