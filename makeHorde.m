...
%
% Needs a recent version of Psychtoolbox-3 (V3.0.15 or later) installed.
%
...
if IsOSX
    % OS/X build:
    if IsOctave
        mex -v Horde3DCore.cpp -I./HordeEngineSDK "-Wno-deprecated-declarations -mmacosx-version-min='10.11'" "-Wl,-headerpad_max_install_names,-F/Library/Frameworks/,-framework,Horde3D,-framework,Horde3DUtils"
